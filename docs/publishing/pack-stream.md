...
keywords: [streaming, Range, HTTP, page-level, big books, fallback]
categories: [packing, hosting]
related: [pack, pack-mode, hosting, khb-internals:streaming]
---
...
> must be served exactly as written. Under [`--mode compact`](pack-mode) streamed
