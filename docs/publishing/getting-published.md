...
keywords: [quick start, pack, viewer, static hosting, docsets.json, publish]
categories: [publishing, packing]
related: [pack, distribution, hosting, khb-authoring:compiling]
---
...
Both JSON files are described in [Anatomy of a distribution](distribution).
...
> locked-down docs? See [Profiles](pack-profiles).
