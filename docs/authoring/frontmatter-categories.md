---
title: categories (frontmatter)
keywords: [categories, facet, tags, filter, categories.yaml, taxonomy]
categories: [configuration]
related: [frontmatter, frontmatter-keywords, docset-products]
---
...
[product filter](docset-products).
