---
title: TOC nodes
keywords: [toc nodes, page node, folder node, children, label override, nesting]
categories: [configuration]
related: [toc-yaml, toc-ordering, frontmatter-title]
---

# TOC nodes

A [toc.yaml](toc-yaml) is a nested list of two node kinds.
...
[title](frontmatter-title). Add a `title:` to **override the label** in the tree
...
folder node without a `title:` fails the [compile](compiling).
