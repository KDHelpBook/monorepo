---
title: Code blocks
keywords: [code, fenced, syntax highlighting, language, monospace, filename, copy button, collapse, code group, tabs, code preview, file tree]
categories: [markdown, extensions]
related: [text-formatting, differences, compiling]
---
...
syntax — see [Differences from GitHub Markdown](differences).
...
> [`ext:example`](extensions) extension — the tool emits this widget for you (compile the
