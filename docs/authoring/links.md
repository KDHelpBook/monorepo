...
[Page links](page-links). And for a curated **See also** footer instead of inline
links, list related page ids in the page's `related` frontmatter — see
[related (frontmatter)](frontmatter-related).
