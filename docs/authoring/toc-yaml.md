---
title: toc.yaml
keywords: [toc.yaml, table of contents, hierarchy, tree, navigation, structure]
categories: [configuration]
related: [toc-nodes, toc-ordering, docset-toml]
---

# toc.yaml

An optional file next to `docset.toml` that defines the book's table-of-contents
tree, referencing pages by [id](frontmatter-id):
