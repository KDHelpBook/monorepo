---
title: toc (frontmatter)
keywords: [toc, on this page, navigation box, sections, headings, override]
categories: [configuration]
related: [frontmatter, headings]
---
...
[heading anchor](headings). `toc: true` shows it regardless of section count;
