---
title: language (docset.toml)
keywords: [language, tokenizer, stemming, diacritics, translations, localization]
categories: [configuration]
related: [docset-toml, docset-collection, khb-internals:full-text-search]
---

# language (docset.toml)

The content language of the book. Content is authored as **one docset per language**;
translations are separate source folders sharing a [collection](docset-collection).
