---
title: products (docset.toml)
keywords: [products, filter, facet, scope, many-to-many, suite]
categories: [configuration]
related: [docset-toml, docset-collection, frontmatter-categories]
---

# products (docset.toml)

The products this book belongs to — a **filter facet**, independent of the
[collection](docset-collection) merge key, and **many-to-many**: one book can belong
...
from several families; the [category facet](frontmatter-categories) composes with it.
